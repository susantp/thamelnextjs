          ...
          <div className="row">
            <div className="col-md-6 col-sm-12 product-single-gallery">
              ...
              >
                <div className="owl-dot active">
                  <img
                    src="assets/images/products/zoom/2-big.jpg"
                    onClick={this.handleClick}
                  />
                </div>
                <div className="owl-dot">
                  <img
                    src="assets/images/products/zoom/3-big.jpg"
                    onClick={this.handleClick}
                  />
                </div>
                <div className="owl-dot">
                  <img
                    src="assets/images/products/zoom/5-big.jpg"
                    onClick={this.handleClick}
                  />
                </div>
                <div className="owl-dot">
                  <img
                    src="assets/images/products/zoom/6-big.jpg"
                    onClick={this.handleClick}
                  />
                </div>
              </div>
            ...
            <div className="col-md-6 col-sm-12 product-single-details">
              <h1 className="product-title">
                Beautiful Tibetan Singing Bowl for Meditation and Healing
              </h1>
                ...
                <div className="tab-content">
                  ...
                  >
                    <div className="product-desc-content">
                      This deluxe Tibetan singing bowl set includes a beautiful
                      brass singing bowl approximately 4 inches in diameter with
                      a soft plush cushion and wooden striker. The singing bowl
                      has a decorative Tibetan Buddhist prayer "Om Mani Padme
                      Hum" inscribed around the outside. The cushion is
                      approximately 1.5 inches thick and has a decorative gold
                      patterned fabric around the outside edge. Easy to play,
                      this singing bowl creates incredibly relaxing sounds that
                      can be used for yoga, meditation, and relaxation. This is
                      the perfect decoration or meditation accessory which can
                      produce peaceful, relaxing sounds to accompany any
                      meditation practice.
                    </div>
                  </div>
                  ...
                  >
                    <div className="product-features-content">
                      ...
                      >
                        <li>
                          Complete Set with Wooden Striker and Cushion, 4 Inch
                          Diameter.
                        </li>
                        <li>
                          Calming, peaceful sounds to enhance meditation and
                          relaxation
                        </li>
                        <li>
                          High quality brass singing bowl with decorative Om
                          Mani Padme Hum inscription
                        </li>
                        <li>
                          Great value: deluxe set includes plush cushion and
                          wooden striker
                        </li>
                        <li>
                          Convenient size: bowl is approximately 4 inches in
                          diameter
                        </li>
                        <li>Easy to play, even for beginners</li>
                      </ul>
                    </div>
                  </div>
                </div>
